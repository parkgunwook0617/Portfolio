                ...
                <div className='flex flex-col w-auto px-5 h-[300px] bg-desert-sand rounded-xl m-auto'>
                    ...
                    <div className='h-full flex gap-15 items-center justify-around'>
                        ...
                        <div className='flex flex-col gap-4'>
                            <div className='sm:text-[24px] text-white'>대학생 연합 IT 동아리</div>
                            <div className='sm:text-[24px] text-white'>2024.12 - 2025.02</div>
                            <div className='sm:text-[24px] text-white'>FullStack</div>
                        </div>
                    </div>
                </div>
                <div className='flex flex-col w-auto px-5 h-[300px] bg-desert-sand rounded-xl m-auto'>
                    ...
                    <div className='h-full flex gap-15 items-center justify-around'>
                        ...
                        <div className='flex flex-col gap-4'>
                            <div className='sm:text-[24px] text-white'>교내 웹 개발 동아리</div>
                            <div className='sm:text-[24px] text-white'>2024.08 - 2025.08</div>
                            <div className='sm:text-[24px] text-white'>Backend</div>
                        </div>
                    </div>
                </div>
                <div className='flex flex-col w-auto px-5 h-[300px] bg-desert-sand rounded-xl m-auto'>
                    ...
                    <div className='h-full flex gap-15 items-center justify-around'>
                        ...
                        <div className='flex flex-col gap-4'>
                            <div className='sm:text-[24px] text-white'>산학협력프로젝트</div>
                            <div className='sm:text-[24px] text-white'>2025.04 - 2025.12</div>
                            <div className='sm:text-[24px] text-white'>FullStack</div>
                        </div>
                    </div>
                </div>
