    ...
    return (
        <div id='history' className='bg-persian-orange'>
            ...
            <div className='flex flex-col gap-[30px] pt-[40px] pb-[40px]'>
                <div className='flex flex-col w-[90%] sm:w-auto px-5 h-[300px] bg-desert-sand rounded-xl m-auto'>
                ...
                <div className='flex flex-col w-[90%] sm:w-auto px-5 h-[300px] bg-desert-sand rounded-xl m-auto'>
                    ...
                    <div className='h-full flex gap-15 items-center justify-around'>
                        ...
                        <div className='flex flex-col gap-4'>
                            <div className='text-[12px] sm:text-[24px] text-white'>교내 웹 개발 동아리</div>
